...
<head>
  ...
  <style>
    ...
    .card { background: #fff; border: 1px solid #e5e7eb; border-radius: 10px; padding: 16px; max-width: 1000px; margin: 0 auto; }
    .muted { color: #6b7280; }
...
<body>
  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
      ...
      <div class="actions">
        <a class="btn" href="/manager/requests/download?pr=<?= rawurlencode($pr) ?>" target="_blank" rel="noopener">Download PDF</a>
    ...
    <div class="grid">
      ...
      <div><div class="label">Prepared On</div><div class="value"><?= htmlspecialchars($preparedAt) ?></div></div>
      <div><div class="label">Requisition By</div><div class="value"><?= htmlspecialchars($requestedBy) ?></div></div>
      <div><div class="label">Status</div><div class="value"><?= htmlspecialchars($status) ?></div></div>
    </div>
