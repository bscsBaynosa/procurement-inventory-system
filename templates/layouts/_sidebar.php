...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <?php if ($role === 'admin'): ?>
            ...
            <a href="/notifications" class="<?= nav_active('/notifications', $path) ?>"><svg viewBox="0 0 24 24"><path d="M12 22a2 2 0 0 0 2-2H10a2 2 0 0 0 2 2zm6-6v-5a6 6 0 1 0-12 0v5l-2 2v1h16v-1l-2-2z"/></svg> Notifications</a>
